...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      "h-12 px-3 text-left align-middle font-medium text-muted-foreground bg-slate-100 border-r border-b border-border last:border-r-0 [&:has([role=checkbox])]:pr-0",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <td
    ref={ref}
    className={cn("px-3 py-2 align-middle bg-white border-r border-border last:border-r-0 [&:has([role=checkbox])]:pr-0", className)}
    {...props}
  />
))
